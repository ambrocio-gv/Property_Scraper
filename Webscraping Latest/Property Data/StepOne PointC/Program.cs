...
namespace StageOne
{
    ...
    internal class Program
    {
        ...
        static async Task MainTask(string proxysite)
        {
            ...
            var proxies = new ProxyRepository().GetProxies(result);
            ...
            foreach (var item in proxies)
            {
                ...
                try
                {
                    //var url = $"https://www.zoopla.co.uk/property/uprn/10070707660/";
        ...
        {
            //var result = await CallUrl("https://sslproxies.org/");
            await MainTask("https://sslproxies.org/");
        }


        static async Task TaskTwo()
        {
            //var result = await CallUrl("https://free-proxy-list.net/");
            await MainTask("https://free-proxy-list.net/");
        }
